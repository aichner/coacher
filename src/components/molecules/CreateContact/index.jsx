          ...
          <>
            <div>
              ...
              <p className="text-muted small">
                What skills does this person hold and how can he/she contribute
                to our efforts?
              </p>
            </div>
                ...
                <div>
                  <MDBRow>
                    <MDBCol lg="4">
                      ...
                      {AVAILABLE_SKILLS.filter((tmp) => tmp.type === "3d").map(
                        (skill, s) => {
                          return (
                            <MDBInput
                              key={s}
                    ...
                    <MDBCol lg="4" className="mt-3">
                      ...
                      {AVAILABLE_SKILLS.filter((tmp) => tmp.type === "web").map(
                        (skill, s) => {
                          return (
                            <MDBInput
                              key={s}
